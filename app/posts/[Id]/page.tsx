            ...
            <div className="py-3 lg:pe-8">
              <div className="space-y-4 lg:space-y-8">
                ...
                <div className="grid lg:flex lg:justify-between lg:items-center gap-y-5 lg:gap-y-0">
                  ...
                  <div>
                    <a
                      className="m-0.5 inline-flex items-center gap-1.5 py-2 px-3 rounded-full text-sm bg-gray-100 text-gray-800 hover:bg-gray-200 :800 :-gray-700 :y-200 :tline-none :ng-1 :ng-gray-600"
                      href="#"
                    >
                      Free
                    </a>
              ...
              <div className="group flex items-center gap-x-3 border-b border-gray-200 pb-8 mb-8 :ray-700">
                ...
                <div className="grow">
                  <div className="flex justify-end">
                    <button
                      type="button"
                      className="py-1.5 px-2.5 inline-flex items-center gap-x-2 text-xs font-semibold rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none :tline-none :ng-1 :ng-gray-600"
                    >
                      <svg
                        className="flex-shrink-0 size-4"
                        xmlns="http://www.w3.org/2000/svg"
